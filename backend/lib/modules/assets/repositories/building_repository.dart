...
class BuildingRepository {
  ...
  Future<List<Building>> findAll() async {
    final result = await _db.execute(
      Sql.named('''
        SELECT id::TEXT, name, property_type::TEXT, total_floors,
  ...
  Future<Building> create({
    ...
    final result = await _db.execute(
      Sql.named('''
        ...
        VALUES (@name, @propertyType::property_type, @totalFloors, @gfa, @nla, @address, @builtYear)
        RETURNING id::TEXT, name, property_type::TEXT, total_floors,
