...
DECLARE
    ...
    v_user_front   UUID := 'f0000000-0000-0000-0000-000000000005'; -- U-MAINT   赵师傅
    ...
    -- Buildings (3) — a0 前缀
    -- =====================================================================
    v_bld_office UUID := 'a0000000-0000-0000-0000-000000000001'; -- B-OFFICE 融创智汇大厦A座
    ...
    -- Floors (11) — b0 前缀
    -- =====================================================================
    v_flr_o_b1  UUID := 'b0000000-0000-0000-0000-000000000001'; -- 融创智汇大厦A座 B1
    v_flr_o_1f  UUID := 'b0000000-0000-0000-0000-000000000002'; -- 融创智汇大厦A座 1F
    v_flr_o_6f  UUID := 'b0000000-0000-0000-0000-000000000003'; -- 融创智汇大厦A座 6F（首个有SVG楼层）
    v_flr_o_10f UUID := 'b0000000-0000-0000-0000-000000000004'; -- 融创智汇大厦A座 10F
    v_flr_o_22f UUID := 'b0000000-0000-0000-0000-000000000005'; -- 融创智汇大厦A座 22F（顶层/SVG覆盖至22F）
    ...
    v_unit_20a01  UUID := 'c0000000-0000-0000-0000-000000000016'; -- 2201-01 旭日软件 100m²
    v_unit_20a02  UUID := 'c0000000-0000-0000-0000-000000000017'; -- 2201-02 星光广告  72m²
    v_unit_20a03  UUID := 'c0000000-0000-0000-0000-000000000018'; -- 2201-03 空置      268m²
    ...
    v_t_corp_d   UUID := 'd0000000-0000-0000-0000-000000000006'; -- T-CORP-D 恒通贸易
    ...
    v_wo_004 UUID := 'bf000000-0000-0000-0000-000000000004'; -- WO-004 环境噪音投诉
    v_wo_005 UUID := 'bf000000-0000-0000-0000-000000000005'; -- WO-005 公区卫生投诉
    v_wo_006 UUID := 'bf000000-0000-0000-0000-000000000006'; -- WO-006 合同到期验房
...
VALUES
    ...
    ('6d000000-0000-0000-0000-000000000001', v_c_office, 1,
     '2025-06-01', '2027-05-31', 'base_after_free_period', NULL, NULL),
    ('6d000000-0000-0000-0000-000000000002', v_c_office, 2,
     '2027-06-01', '2028-05-31', 'fixed_rate', 0.050000, NULL),
    -- C-RETAIL-01 阶梯式三段（保底单价递增，fixed_amount 存阶段基准单价）
    ('6d000000-0000-0000-0000-000000000003', v_c_retail, 1,
     '2025-03-01', '2026-02-28', 'step', NULL, 230.00),
    ('6d000000-0000-0000-0000-000000000004', v_c_retail, 2,
     '2026-03-01', '2027-02-28', 'step', NULL, 250.00),
    ('6d000000-0000-0000-0000-000000000005', v_c_retail, 3,
     '2027-03-01', '2028-02-28', 'step', NULL, 270.00),
    -- C-SUB-MASTER 每2年递增8%
    ('6d000000-0000-0000-0000-000000000006', v_c_sub, 1,
     '2024-01-01', '2025-12-31', 'base_after_free_period', NULL, NULL),
    ('6d000000-0000-0000-0000-000000000007', v_c_sub, 2,
     '2026-01-01', '2027-12-31', 'periodic', 0.080000, NULL),
    ('6d000000-0000-0000-0000-000000000008', v_c_sub, 3,
...
VALUES
    ...
    ('5d000000-0000-0000-0000-000000000002', NULL, v_user_lease, v_bld_office, v_flr_o_22f);
