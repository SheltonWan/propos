...
| F2 | FE-03 | 资产台账列表、详情（含 market_rent_reference）（批量导入仅 Admin 端，Flutter 不支持） | FE-01, BE-05 | 资产模块基础页面 |
...
### v1.6 工期压缩（2026-04-27）

- 总工期从 20 周压缩至 17 周，起始日 2026-04-20，结束日 2026-08-14。
- Phase 0（2026-04-08–2026-04-17）已完成，泳道排期从 Phase 1（W1）起算。
- 原 Phase 7 UAT（5 天，W20）已压缩并入 Phase 6 第 17 周（W17：8/10–8/14）执行。
- 泯道内具体任务不变，仅日历区间映射调整，依据 PROJECT_PLAN.md v1.5 执行。
