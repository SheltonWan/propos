...
python scripts/extract_floor_map.py \
  ...
  -o floors/a0000000-0000-4000-8000-000000000001/b0000000-0000-4000-8000-000000000001.json

# 同步 SVG 到最终目录
cp cad_intermediate/building_a/1F_annotated.svg \
   floors/a0000000-0000-4000-8000-000000000001/b0000000-0000-4000-8000-000000000001.svg

# === Step 5: 校验 ===
bash scripts/validate_floor_svg.sh \
  floors/a0000000-0000-4000-8000-000000000001/b0000000-0000-4000-8000-000000000001.svg \
  floors/a0000000-0000-4000-8000-000000000001/b0000000-0000-4000-8000-000000000001.json
```
