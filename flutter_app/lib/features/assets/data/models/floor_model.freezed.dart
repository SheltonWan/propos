...
mixin _$FloorModel {
 ...
 String get id;@JsonKey(name: 'building_id') String get buildingId;@JsonKey(name: 'building_name') String get buildingName;@JsonKey(name: 'floor_number') int get floorNumber;@JsonKey(name: 'floor_name') String? get floorName;/// 楼层业态（001 新增）
@JsonKey(name: 'property_type') String? get propertyType;@JsonKey(name: 'svg_path') String? get svgPath;@JsonKey(name: 'png_path') String? get pngPath; double? get nla;@JsonKey(name: 'created_at') String get createdAt;@JsonKey(name: 'updated_at') String get updatedAt;
...
@override
String toString() {
  return 'FloorModel(id: $id, buildingId: $buildingId, buildingName: $buildingName, floorNumber: $floorNumber, floorName: $floorName, propertyType: $propertyType, svgPath: $svgPath, pngPath: $pngPath, nla: $nla, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id,@JsonKey(name: 'building_id') String buildingId,@JsonKey(name: 'building_name') String buildingName,@JsonKey(name: 'floor_number') int floorNumber,@JsonKey(name: 'floor_name') String? floorName,@JsonKey(name: 'property_type') String? propertyType,@JsonKey(name: 'svg_path') String? svgPath,@JsonKey(name: 'png_path') String? pngPath, double? nla,@JsonKey(name: 'created_at') String createdAt,@JsonKey(name: 'updated_at') String updatedAt
});
