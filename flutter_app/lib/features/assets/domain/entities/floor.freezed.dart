...
mixin _$Floor {
 ...
 String get id; String get buildingId; String get buildingName; int get floorNumber; String? get floorName; String? get svgPath; String? get pngPath; double? get nla; DateTime get createdAt; DateTime get updatedAt;
...
@override
String toString() {
  return 'Floor(id: $id, buildingId: $buildingId, buildingName: $buildingName, floorNumber: $floorNumber, floorName: $floorName, svgPath: $svgPath, pngPath: $pngPath, nla: $nla, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String buildingId, String buildingName, int floorNumber, String? floorName, String? svgPath, String? pngPath, double? nla, DateTime createdAt, DateTime updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String buildingId,  String buildingName,  int floorNumber,  String? floorName,  String? svgPath,  String? pngPath,  double? nla,  DateTime createdAt,  DateTime updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Floor() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String buildingId,  String buildingName,  int floorNumber,  String? floorName,  String? svgPath,  String? pngPath,  double? nla,  DateTime createdAt,  DateTime updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Floor():
return $default(_that.id,_that.buildingId,_that.buildingName,_that.floorNumber,_that.floorName,_that.svgPath,_that.pngPath,_that.nla,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String buildingId,  String buildingName,  int floorNumber,  String? floorName,  String? svgPath,  String? pngPath,  double? nla,  DateTime createdAt,  DateTime updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Floor() when $default != null:
return $default(_that.id,_that.buildingId,_that.buildingName,_that.floorNumber,_that.floorName,_that.svgPath,_that.pngPath,_that.nla,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _Floor extends Floor {
  const _Floor({required this.id, required this.buildingId, required this.buildingName, required this.floorNumber, this.floorName, this.svgPath, this.pngPath, this.nla, required this.createdAt, required this.updatedAt}): super._();
